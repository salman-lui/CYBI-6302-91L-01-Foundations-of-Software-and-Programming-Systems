...
'''
Complete the implementation in Python of the pending functionality 9 and 10 in the menu-driven program below that shows 
on the console statistic values from a series of n real numbers inserted by the user. Use as reference the project developed for homework 2.2. 
Taking into consideration that the functions max(list), min(list), mean(list), sum(list), std(list), var(list) are defined in the package numpy, 
import that package into the project and simply the code.
...
7.- Full Report
8.- Show Series
9.- Read series from input file 
10.- Write series to output file
0.- Quit
'''
